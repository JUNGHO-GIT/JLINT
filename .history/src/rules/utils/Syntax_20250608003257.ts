...
export const capitalize = async (
  ...
  try {
    ...
    const rules1 = /(\b)(select|from|where|insert|into|values|update|set|delete|join|on|create)(\b)/gm;
    const rules2 = /(\b)(table|alter|drop|truncate|order by|group\s+by|having|limit|offset|distinct)(\b)/gm;
    const rules3 = /(\b)(and|or|not|null|is|in|like|between|as)(\b)/gm;
