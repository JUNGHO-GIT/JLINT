(function  () {
  var MutationObserver, Util, WeakMap, getComputedStyle, getComputedStyleRX, bind = function (fn, me) {
      ...
      i < l; i++) {
          if (i in thi && this[i] === item) return i;
        }
        return -1;
      };
  Util = (function  () {
  ...
  this.WOW = (function  () {
    ...
    WOW.prototype.start = function  () {
      ...
      if (!this.disabled()) {
        ...
        this.interval = etInterval(this.scrollCallback, 50);
      }
      if (this.config.live) {
    ...
    WOW.prototype.vendor = ["moz", "webkit"];
    ...
    WOW.prototype.vendorCSS = function  (elem, property) {
      ...
      result = tyle.getPropertyCSSValue(property);
      ref = this.vendors;
