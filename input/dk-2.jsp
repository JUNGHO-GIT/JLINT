<%@page language="java" contentType="text/html;
  charset=UTF-8" pageEncoding="UTF-8"%> <%@ include file="/header/header.jsp" %><link rel="stylesheet" type="text/css" href="${ctxpath}/css/inputForm_css.css" />
    ...
    <script type="text/javascript">
      function idCheck() {
        if ($("#id").val() == "") {
          ...
          $.ajax({
            type: "POST", url: "confirmID.jsp", data: "id=" + $("#id").val(), dataType: "JSON", success: function (data) {
              if (data.x == 1) {
                alert("사용 중인 id입니다");
                $("#id").val("").focus();
              }
  ...
  <body>
    ...
    <form name="inputForm" method="post" action="${ctxpath}/member/inputPro.do" onSubmit="return check2()">
      <table>
        ...
        <tr>
          <td>암호</td>
          <td><input type="password" name="pw" id="pw" size="12" onFocus="aa()" /></td>
        </tr>
