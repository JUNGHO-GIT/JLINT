...
import { getPrettier, getPrettierPluginJsp } from "@exportLibs";
...
export const removeComments = async (
  ...
  try {
    ...
    .replaceAll(pattern1, (...p: unknown[]) => (
      `${p[1]}${p[2]}httpp${p[4]}${p[5]}`
    ))
    .replaceAll(pattern2, (...p: unknown[]) => (
      `${p[1]}${p[2]}httpps${p[4]}${p[5]}`
    ))
    .replaceAll(pattern3, (...p: unknown[]) => (
      `${p[1]}${p[2]}@{httpp${p[4]}${p[5]}`
    ))
    .replaceAll(pattern4, (...p: unknown[]) => (
      `${p[1]}${p[2]}@{httpps${p[4]}${p[5]}`
    ));
    ...
    .replaceAll(pattern1Re, (...p: unknown[]) => (
      `${p[1]}${p[2]}http://${p[4]}${p[5]}`
    ))
    .replaceAll(pattern2Re, (...p: unknown[]) => (
      `${p[1]}${p[2]}https://${p[4]}${p[5]}`
    ))
    .replaceAll(pattern3Re, (...p: unknown[]) => (
      `${p[1]}${p[2]}@{http://${p[4]}${p[5]}`
    ))
    .replaceAll(pattern4Re, (...p: unknown[]) => (
      `${p[1]}${p[2]}@{https://${p[4]}${p[5]}`
    ))
    .replaceAll(pattern5, (...p: unknown[]) => (
      `${p[1]}`
    ));
