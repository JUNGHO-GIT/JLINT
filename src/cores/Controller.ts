...
// -------------------------------------------------------------------------------------------------
export const getLanguage = async (commonParam: CommonType, initContents: string, fileName: string, fileTabSize: number, fileEol: string, fileExt: string) => {
...
// -------------------------------------------------------------------------------------------------
export const getSyntax = async (commonParam: CommonType, afterLanguageContents: string, fileExt: string) => {
...
// -------------------------------------------------------------------------------------------------
export const getLogic = async (commonParam: CommonType, afterSyntaxContents: string, fileExt: string) => {
...
// -------------------------------------------------------------------------------------------------
export const getFinalCheck = async (commonParam: CommonType, afterLogicContents: string, fileExt: string) => {
