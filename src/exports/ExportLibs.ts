...
export const getPrettierPluginJava = async () =>
	_getModuleWithCache(`prettier-plugin-java`);
export const getPrettierPluginJsp = async () =>
	_getModuleWithCache(`prettier-plugin-jsp`);
export const getPrettierPluginXml = async () =>
	_getModuleWithCache(`@prettier/plugin-xml`);
export const getPrettierPluginYaml = async () =>
	_getModuleWithCache(`prettier/plugins/yaml`);
